        ...
        content: Obx(()=>
          c.isloading.value ? const Center(
            ...
            children: const [
              ...
              AllItem(widgetIndex: 0, day: '星期日',),
              AllItemTitle(title: '星期一'),
              AllItem(widgetIndex: 1, day: '星期一',),
              AllItemTitle(title: '星期二'),
              AllItem(widgetIndex: 2, day: '星期二',),
              AllItemTitle(title: '星期三'),
              AllItem(widgetIndex: 3, day: '星期三',),
              AllItemTitle(title: '星期四'),
              AllItem(widgetIndex: 4, day: '星期四',),
              AllItemTitle(title: '星期五'),
              AllItem(widgetIndex: 5, day: '星期五',),
              AllItemTitle(title: '星期六'),
              AllItem(widgetIndex: 6, day: '星期六',),
            ],
          ),
        ),
        actions: [
